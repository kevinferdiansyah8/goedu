...
@section('title', 'Mengerjakan Pretest')
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-6">
    <div class="max-w-3xl mx-auto bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-orange-500 to-rose-600 p-6 text-white">
            <span class="text-xs font-bold text-orange-200 uppercase tracking-wider">Tes Awal (Pretest)</span>
        ...
        {{-- Form --}}
        <form action="{{ route('siswa.elearning.pretest.submit', $session->id) }}" method="POST" class="p-6 space-y-6">
            @csrf

...
@section('title', 'Pendaftaran SD - Step 2 | Data Keluarga')
@section('content')
...
<section class="min-h-[calc(100vh-120px)] flex items-center justify-center py-10 px-4">
  <div class="w-full max-w-xl">
    ...
    <div class="flex items-center justify-center mb-8">
      ...
      <div class="flex flex-col items-center">
        <div class="w-10 h-10 rounded-full bg-red-500 text-white flex items-center justify-center font-bold text-sm shadow-lg shadow-red-200 ring-4 ring-red-100">2</div>
        <span class="text-xs font-semibold text-red-500 mt-1.5">Data Keluarga</span>
      </div>
    ...
    <div class="bg-white rounded-3xl shadow-xl shadow-gray-100/80 border border-gray-100 overflow-hidden">
      ...
      <div class="bg-gradient-to-r from-red-500 to-red-400 px-8 py-6">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-red-100 text-xs font-medium uppercase tracking-widest">Pendaftaran SD • Langkah 2 dari 3</p>
      ...
      {{-- Body --}}
      <div class="px-8 py-8">
        <form action="{{ url('/ppdb/register/sd/step3') }}" method="get" class="space-y-5">
          ...
          <div class="group">
            ...
            <p class="text-xs text-gray-400 mt-1.5 ml-1">Untuk pengiriman bukti & hasil pendaftaran.</p>
          </div>
          ...
          <div class="group">
            ...
            <div class="relative">
              ...
              <select name="pekerjaan" required
                class="w-full pl-11 pr-10 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-100 focus:border-red-400 focus:bg-white transition-all appearance-none cursor-pointer">
                <option value="" disabled selected>Pilih pekerjaan</option>
                <option>PNS / ASN</option>
                <option>TNI / POLRI</option>
                <option>Karyawan Swasta</option>
                <option>Wiraswasta / Pengusaha</option>
                <option>Petani / Buruh Tani</option>
                <option>Nelayan</option>
                <option>Guru / Tenaga Pendidik</option>
          ...
          <div class="group">
            ...
            <div class="relative">
              ...
              <textarea name="alamat" rows="3" placeholder="Jl. Nama Jalan No. XX, RT/RW, Kelurahan, Kecamatan, Kota" required
                class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-sm placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-red-100 focus:border-red-400 focus:bg-white transition-all"></textarea>
            </div>
          </div>
          ...
          <div class="flex gap-3">
            <a href="{{ url('/ppdb/register/sd/step1?jalur='.request('jalur')) }}"

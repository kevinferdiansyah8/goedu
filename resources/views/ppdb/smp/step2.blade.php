...
@section('title', 'Pendaftaran SMP - Step 2 | Data Keluarga')
@section('content')
...
<section class="min-h-[calc(100vh-120px)] flex items-center justify-center py-10 px-4">
  <div class="w-full max-w-xl">
    ...
    <div class="flex items-center justify-center mb-8">
      ...
      <div class="flex flex-col items-center">
        <div class="w-10 h-10 rounded-full bg-indigo-600 text-white flex items-center justify-center font-bold text-sm shadow-lg shadow-indigo-200 ring-4 ring-indigo-100">2</div>
        <span class="text-xs font-semibold text-indigo-600 mt-1.5">Data Keluarga</span>
      </div>
    ...
    <div class="bg-white rounded-3xl shadow-xl shadow-gray-100/80 border border-gray-100 overflow-hidden">
      ...
      <div class="bg-gradient-to-r from-indigo-600 to-indigo-500 px-8 py-6">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="text-indigo-100 text-xs font-medium uppercase tracking-widest">Pendaftaran SMP • Langkah 2 dari 3</p>
      ...
      {{-- Body --}}
      <div class="px-8 py-8">
        <form action="{{ url('/ppdb/register/smp/step3') }}" method="get" class="space-y-5">
          ...
          <div class="group">
            ...
            <div class="relative">
              ...
              <select name="pekerjaan" required
                class="w-full pl-11 pr-10 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 focus:bg-white transition-all appearance-none cursor-pointer">
          ...
          <div class="group">
            ...
            <div class="relative">
              ...
              <textarea name="alamat" rows="3" placeholder="Jl. Nama Jalan No. XX, RT/RW, Kelurahan, Kecamatan, Kota" required
                class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-sm placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-400 focus:bg-white transition-all"></textarea>
            </div>
          </div>
          ...
          <div class="flex gap-3">
            <a href="{{ url('/ppdb/register/smp/step1?jalur='.request('jalur')) }}"

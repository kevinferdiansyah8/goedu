  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center gap-12">
      ...
      <div class="hidden lg:block shrink-0">
        <img src="{{ asset('images/ppdb-students.png') }}" alt="Ilustrasi Siswa PPDB"
          class="w-44 object-contain" onerror="this.style.display='none'">
      </div>

      {{-- Cards --}}
      <div class="flex-1">
        <h2 class="text-xl font-extrabold text-gray-800 mb-6 uppercase tracking-wide">Jenjang Dan Jalur Pendaftaran</h2>

        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">

          {{-- SD --}}
          <a href="{{ url('/ppdb/jenjang/sd') }}"
            class="group block rounded-2xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200">
            <div class="bg-gradient-to-br from-red-500 to-red-700 p-6 flex flex-col items-center justify-center min-h-[160px] relative">
              {{-- Pattern dots --}}
              <div class="absolute inset-0 opacity-10"
                style="background-image: radial-gradient(circle, white 1px, transparent 1px); background-size: 16px 16px;"></div>
              <span class="relative text-white text-3xl font-extrabold mb-2 drop-shadow">SD</span>
              <span class="relative text-orange-200 text-2xl font-bold mb-1">3 Jalur</span>
              <span class="relative text-white/80 text-xs font-medium tracking-wide">Pendaftaran</span>
            </div>
          </a>
          ...
          <a href="{{ url('/ppdb/jenjang/smp') }}"
            class="group block rounded-2xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200">
            <div class="bg-gradient-to-br from-blue-600 to-blue-800 p-6 flex flex-col items-center justify-center min-h-[160px] relative">
              <div class="absolute inset-0 opacity-10"
                style="background-image: radial-gradient(circle, white 1px, transparent 1px); background-size: 16px 16px;"></div>
              <span class="relative text-white text-3xl font-extrabold mb-2 drop-shadow">SMP</span>
              <span class="relative text-blue-200 text-2xl font-bold mb-1">4 Jalur</span>
              <span class="relative text-white/80 text-xs font-medium tracking-wide">Pendaftaran</span>
            </div>
          </a>
          ...
          <a href="{{ url('/ppdb/jenjang/sma') }}"
            class="group block rounded-2xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200">
            <div class="bg-gradient-to-br from-slate-500 to-slate-700 p-6 flex flex-col items-center justify-center min-h-[160px] relative">
              <div class="absolute inset-0 opacity-10"
                style="background-image: radial-gradient(circle, white 1px, transparent 1px); background-size: 16px 16px;"></div>
              <span class="relative text-white text-3xl font-extrabold mb-2 drop-shadow">SMA</span>
              <span class="relative text-slate-200 text-2xl font-bold mb-1">4 Jalur</span>
              <span class="relative text-white/80 text-xs font-medium tracking-wide">Pendaftaran</span>
            </div>
          </a>
          ...
          <a href="{{ url('/ppdb/jenjang/smk') }}"
            class="group block rounded-2xl overflow-hidden shadow-md hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200">
            <div class="bg-gradient-to-br from-gray-600 to-gray-800 p-6 flex flex-col items-center justify-center min-h-[160px] relative">
              <div class="absolute inset-0 opacity-10"
                style="background-image: radial-gradient(circle, white 1px, transparent 1px); background-size: 16px 16px;"></div>
              <span class="relative text-white text-3xl font-extrabold mb-2 drop-shadow">SMK</span>
              <span class="relative text-gray-200 text-2xl font-bold mb-1">4 Jalur</span>
              <span class="relative text-white/80 text-xs font-medium tracking-wide">Pendaftaran</span>
            </div>
          </a>

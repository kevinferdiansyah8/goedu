...
@section('title', 'PPDB SMA - Pilih Jalur Pendaftaran')
@section('content')
...
<section class="py-10 px-4">
  <div class="max-w-5xl mx-auto">
    ...
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-8">
      <a href="{{ url('/ppdb') }}" class="hover:text-emerald-600 transition-colors">PPDB</a>
      <i data-lucide="chevron-right" class="w-4 h-4 text-gray-400"></i>
      <span class="text-gray-800 font-medium">Sekolah Menengah Atas (SMA)</span>
    </nav>

    <div class="text-center mb-10">
      <span class="inline-flex items-center gap-2 bg-emerald-100 text-emerald-700 text-xs font-semibold px-4 py-1.5 rounded-full mb-4">
        <i data-lucide="school" class="w-3.5 h-3.5"></i> Jenjang SMA
      </span>
      <h1 class="text-2xl md:text-3xl font-extrabold text-gray-900 mb-3 leading-tight">
        ...
        <span class="text-emerald-600">Sekolah Menengah Atas (SMA)</span>
      </h1>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 mb-10">
      ...
      <a href="{{ url('/ppdb/register/sma/step1?jalur=zonasi') }}"
      ...
      <a href="{{ url('/ppdb/register/sma/step1?jalur=afirmasi') }}"
        class="group relative block rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
      ...
      <a href="{{ url('/ppdb/register/sma/step1?jalur=perpindahan') }}"
        class="group relative block rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
      ...
      {{-- 4. Prestasi --}}
      <a href="{{ url('/ppdb/register/sma/step1?jalur=prestasi') }}"
        class="group relative block rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden">
    ...
    <div class="bg-emerald-50 border border-emerald-100 rounded-2xl px-5 py-4 flex items-start gap-3 mb-8">
      <i data-lucide="info" class="w-5 h-5 text-emerald-500 shrink-0 mt-0.5"></i>
      <p class="text-sm text-emerald-700 leading-relaxed">
        Siapkan ijazah SMP, SKHUN, dan rapor SMP kelas 7–9 sebelum mendaftar.
        Pilihan jurusan (IPA/IPS/Bahasa) akan ditentukan saat pengisian formulir.
      </p>
    </div>
